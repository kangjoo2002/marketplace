...
-- B3 required-offset result equivalence validation.

SET statement_timeout = '10min';

\echo validate_equivalence_b3_start
...
\echo b3_required_offset_10000_equivalence
...
SELECT
    'B3_deep_offset_option_filter' AS scenario,
    10000 AS offset_rows,
